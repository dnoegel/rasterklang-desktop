...
const FAMILIES = {
  LDA: { kind: "load",     summary: "Lade Akkumulator A.",    sets: ["A", "N", "Z"] },
  LDX: { kind: "load",     summary: "Lade X-Register.",       sets: ["X", "N", "Z"] },
  LDY: { kind: "load",     summary: "Lade Y-Register.",       sets: ["Y", "N", "Z"] },
  STA: { kind: "store",    summary: "Schreibe A in Speicher.", sets: ["mem"] },
  STX: { kind: "store",    summary: "Schreibe X in Speicher.", sets: ["mem"] },
  STY: { kind: "store",    summary: "Schreibe Y in Speicher.", sets: ["mem"] },
  ...
  ADC: { kind: "alu",      summary: "Addiere mit Carry.", sets: ["A", "N", "Z", "C", "V"] },
  SBC: { kind: "alu",      summary: "Subtrahiere mit Carry.", sets: ["A", "N", "Z", "C", "V"] },
  AND: { kind: "alu",      summary: "Bit-AND.", sets: ["A", "N", "Z"] },
  ORA: { kind: "alu",      summary: "Bit-OR.",  sets: ["A", "N", "Z"] },
  EOR: { kind: "alu",      summary: "Bit-XOR.", sets: ["A", "N", "Z"] },
  CMP: { kind: "alu",      summary: "Vergleiche A.", sets: ["N", "Z", "C"] },
  CPX: { kind: "alu",      summary: "Vergleiche X.", sets: ["N", "Z", "C"] },
  CPY: { kind: "alu",      summary: "Vergleiche Y.", sets: ["N", "Z", "C"] },
  INC: { kind: "alu",      summary: "Speicher +1.", sets: ["mem", "N", "Z"] },
  INX: { kind: "alu",      summary: "X +1.", sets: ["X", "N", "Z"] },
  INY: { kind: "alu",      summary: "Y +1.", sets: ["Y", "N", "Z"] },
  DEC: { kind: "alu",      summary: "Speicher -1.", sets: ["mem", "N", "Z"] },
  DEX: { kind: "alu",      summary: "X -1.", sets: ["X", "N", "Z"] },
  DEY: { kind: "alu",      summary: "Y -1.", sets: ["Y", "N", "Z"] },
  ASL: { kind: "alu",      summary: "Arith Shift links.", sets: ["A?", "mem?", "N", "Z", "C"] },
  LSR: { kind: "alu",      summary: "Logical Shift rechts.", sets: ["A?", "mem?", "N", "Z", "C"] },
  ROL: { kind: "alu",      summary: "Rotate links durch Carry.", sets: ["A?", "mem?", "N", "Z", "C"] },
  ROR: { kind: "alu",      summary: "Rotate rechts durch Carry.", sets: ["A?", "mem?", "N", "Z", "C"] },
  BIT: { kind: "alu",      summary: "Bit-Test (AND ohne Speichern).", sets: ["N", "V", "Z"] },
  CLC: { kind: "flag",     summary: "C = 0.", sets: ["C"] },
  SEC: { kind: "flag",     summary: "C = 1.", sets: ["C"] },
  CLI: { kind: "flag",     summary: "Interrupt-Mask aus.", sets: ["I"] },
  SEI: { kind: "flag",     summary: "Interrupt-Mask an.", sets: ["I"] },
  CLD: { kind: "flag",     summary: "Dezimalmodus aus.", sets: ["D"] },
  SED: { kind: "flag",     summary: "Dezimalmodus an.", sets: ["D"] },
  CLV: { kind: "flag",     summary: "V = 0.", sets: ["V"] },
  JMP: { kind: "branch",   summary: "Springe.", sets: ["PC"] },
  JSR: { kind: "branch",   summary: "Springe in Subroutine, Ruecksprung auf Stack.", sets: ["PC", "SP", "stack"] },
  RTS: { kind: "branch",   summary: "Ruecksprung aus Subroutine.", sets: ["PC", "SP"] },
  RTI: { kind: "branch",   summary: "Ruecksprung aus IRQ (PC + Flags).", sets: ["PC", "P", "SP"] },
  BCC: { kind: "branch",   summary: "Springe wenn C = 0.", sets: ["PC"] },
  BCS: { kind: "branch",   summary: "Springe wenn C = 1.", sets: ["PC"] },
  BEQ: { kind: "branch",   summary: "Springe wenn Z = 1.", sets: ["PC"] },
  BNE: { kind: "branch",   summary: "Springe wenn Z = 0.", sets: ["PC"] },
  BMI: { kind: "branch",   summary: "Springe wenn N = 1.", sets: ["PC"] },
  BPL: { kind: "branch",   summary: "Springe wenn N = 0.", sets: ["PC"] },
  BVC: { kind: "branch",   summary: "Springe wenn V = 0.", sets: ["PC"] },
  BVS: { kind: "branch",   summary: "Springe wenn V = 1.", sets: ["PC"] },
  PHA: { kind: "stack",    summary: "Pushe A.", sets: ["SP", "stack"] },
  PHP: { kind: "stack",    summary: "Pushe Flags.", sets: ["SP", "stack"] },
  PLA: { kind: "stack",    summary: "Pop A.", sets: ["A", "SP", "N", "Z"] },
  PLP: { kind: "stack",    summary: "Pop Flags.", sets: ["P", "SP"] },
  NOP: { kind: "misc",     summary: "Keine Aktion." , sets: [] },
