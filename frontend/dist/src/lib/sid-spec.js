...
export const REGISTER_MAP = [
  // Voice 1
  { addr: 0xD400, name: "FRELO1",  voice: 1, kind: "freq-lo",   purpose: "Frequenz Lo-Byte (Stimme 1)" },
  { addr: 0xD401, name: "FREHI1",  voice: 1, kind: "freq-hi",   purpose: "Frequenz Hi-Byte (Stimme 1)" },
  { addr: 0xD402, name: "PWLO1",   voice: 1, kind: "pw-lo",     purpose: "Pulsbreite Lo-Byte" },
  { addr: 0xD403, name: "PWHI1",   voice: 1, kind: "pw-hi",     purpose: "Pulsbreite Hi-Byte (4 Bit)" },
  { addr: 0xD404, name: "VCREG1",  voice: 1, kind: "control",   purpose: "Wellenform + Gate + Sync + Ring + Test" },
  { addr: 0xD405, name: "ATDCY1",  voice: 1, kind: "ad",        purpose: "Attack/Decay (Huellkurve)" },
  { addr: 0xD406, name: "SUREL1",  voice: 1, kind: "sr",        purpose: "Sustain/Release (Huellkurve)" },
  // Voice 2
  { addr: 0xD407, name: "FRELO2",  voice: 2, kind: "freq-lo",   purpose: "Frequenz Lo-Byte (Stimme 2)" },
  { addr: 0xD408, name: "FREHI2",  voice: 2, kind: "freq-hi",   purpose: "Frequenz Hi-Byte (Stimme 2)" },
  { addr: 0xD409, name: "PWLO2",   voice: 2, kind: "pw-lo",     purpose: "Pulsbreite Lo-Byte" },
  { addr: 0xD40A, name: "PWHI2",   voice: 2, kind: "pw-hi",     purpose: "Pulsbreite Hi-Byte (4 Bit)" },
  { addr: 0xD40B, name: "VCREG2",  voice: 2, kind: "control",   purpose: "Wellenform + Gate + Sync + Ring + Test" },
  { addr: 0xD40C, name: "ATDCY2",  voice: 2, kind: "ad",        purpose: "Attack/Decay (Huellkurve)" },
  { addr: 0xD40D, name: "SUREL2",  voice: 2, kind: "sr",        purpose: "Sustain/Release (Huellkurve)" },
  // Voice 3
  { addr: 0xD40E, name: "FRELO3",  voice: 3, kind: "freq-lo",   purpose: "Frequenz Lo-Byte (Stimme 3)" },
  { addr: 0xD40F, name: "FREHI3",  voice: 3, kind: "freq-hi",   purpose: "Frequenz Hi-Byte (Stimme 3)" },
  { addr: 0xD410, name: "PWLO3",   voice: 3, kind: "pw-lo",     purpose: "Pulsbreite Lo-Byte" },
  { addr: 0xD411, name: "PWHI3",   voice: 3, kind: "pw-hi",     purpose: "Pulsbreite Hi-Byte (4 Bit)" },
  { addr: 0xD412, name: "VCREG3",  voice: 3, kind: "control",   purpose: "Wellenform + Gate + Sync + Ring + Test" },
  { addr: 0xD413, name: "ATDCY3",  voice: 3, kind: "ad",        purpose: "Attack/Decay (Huellkurve)" },
  { addr: 0xD414, name: "SUREL3",  voice: 3, kind: "sr",        purpose: "Sustain/Release (Huellkurve)" },
  // Filter
  ...
  { addr: 0xD417, name: "RESON",   voice: 0, kind: "res-route", purpose: "Resonanz + Filter-Routing" },
  ...
  { addr: 0xD41B, name: "OSC3",    voice: 0, kind: "ro",        purpose: "Oszillator 3 Output (read)" },
  { addr: 0xD41C, name: "ENV3",    voice: 0, kind: "ro",        purpose: "Huellkurve 3 Pegel (read)" },
];
