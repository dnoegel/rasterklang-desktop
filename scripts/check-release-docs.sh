...
require_text README.md "The release workflow has no tag trigger and no repository-variable fallback"
require_text README.md "guarded root release helper must dispatch it with"
